...
const dicionarioDeSinonimos = {
  ...
  // Adicionando nomes oficiais que descobrimos para consistência
  'air force': 'Air Force',
  'air force premium': 'Air Force Premium',
  'dunk low premium': 'Dunk Low Premium',

  // O RESTANTE DO SEU DICIONÁRIO COMPLETO
  'force': 'Air Force',
  'tn': 'TN Air',
  'air max tn': 'TN Air',
    'dunk': 'Dunk Low',
  ...
  // ADVERSARY
  'adversary': 'Adversary',
  'adiversari': 'Adversary',
  'adversari': 'Adversary',
  'adverssary': 'Adversary',
  ...
  // AIR FORCE STUSSY
  'air force stussy': 'Air Force Stussy',
  'estussy': 'Air Force Stussy',
  'stusy': 'Air Force Stussy',
  'stusi': 'Air Force Stussy',
  'estusi': 'Air Force Stussy',
  'istussy': 'Air Force Stussy',

  // AIR FORCE GAMMA
  'air force gamma': 'Air Force Gamma',
  'gama': 'Air Force Gamma',
  'gaama': 'Air Force Gamma',

  // AIR JORDAN 4
  'air jordan 4': 'Air Jordan 4',
  'jordan 4': 'Air Jordan 4',
  'ar jordan 4': 'Air Jordan 4',
  'jordam 4': 'Air Jordan 4',
  'jordao 4': 'Air Jordan 4',
  'jordana 4': 'Air Jordan 4',
  'jorda 4': 'Air Jordan 4',

  // AIR JORDAN 6
  'air jordan 6': 'Air Jordan 6',
  'jordan 6': 'Air Jordan 6',
  'ar jordan 6': 'Air Jordan 6',
  'air jordana 6': 'Air Jordan 6',

  // AIR JORDAN LOW
  'air jordan low': 'Air Jordan Low',
  'ar jordan lou': 'Air Jordan Low',
  'air jordan lou': 'Air Jordan Low',
  'jordan low': 'Air Jordan Low',
  'jordan lou': 'Air Jordan Low',
  'gordan low': 'Air Jordan Low',
  
  // AIR JORDAN 1
  'air jordan 1': 'Air Jordan 1',
  'jordan 1': 'Air Jordan 1',
  'jordao 1': 'Air Jordan 1',
  'jordana 1': 'Air Jordan 1',
  ...
  'ar max 90': 'Air Max 90',
  'ar mex 90': 'Air Max 90',
  'air mex 90': 'Air Max 90',
  'max 90': 'Air Max 90',
  'air max bolha': 'Air Max 90',

  // AIR MAX 90 EXCEE
  'air max 90 excee': 'Air Max 90 Excee',
  '90 excee': 'Air Max 90 Excee',
  'air max excee': 'Air Max 90 Excee',
  'air max 90 exce': 'Air Max 90 Excee',

  // AIR MAX 95
  'air max 95': 'Air Max 95',
  'ar max 95': 'Air Max 95',
  'ar mex 95': 'Air Max 95',
  'air mex 95': 'Air Max 95',
  'max 95': 'Air Max 95',

  // AIR MAX 97
  'air max 97': 'Air Max 97',
  'ar max 97': 'Air Max 97',
  'ar mex 97': 'Air Max 97',
  'air mex 97': 'Air Max 97',
  'max 97': 'Air Max 97',
  ...
  'tn air': 'TN Air',
  'air max tn': 'TN Air',
  'tn plus': 'TN Air 2', // Casos especiais podem apontar para outros
  'tn air 2': 'TN Air 2',
  ...
  'allstar': 'All Star',
  'austar': 'All Star',
  'lona': 'All Star', // Genérico, mas pode funcionar
  'tecido': 'All Star',
  
  // ALL STAR BOTA
  'all star bota': 'All Star Bota',
  'bota': 'All Star Bota', // Genérico, cuidado
  'botinha': 'All Star Bota',
  'alto': 'All Star Bota',
  'cano alto': 'All Star Bota',
  ...
  // FORCE (Genérico para Air Force)
  'force': 'Air Force',
  'foice': 'Air Force',
  'forci': 'Air Force',
  
  // Atributos de Tênis
  'chaveirinho': 'Chaveirinho',
  'chaveiro': 'Chaveirinho',
  'holográfico': 'Holográfico',
  'holografico': 'Holográfico',
  'holo': 'Holográfico',
  'holografic': 'Holográfico',
  'refletivo': 'Holográfico',
  'shadow': 'Shadow',
  'shadol': 'Shadow',
  'xadol': 'Shadow',
  'xadow': 'Shadow',
  ...
  // INVICTUS 3
  'invictus 3': 'Invictus 3',
  'inviquitus 3': 'Invictus 3',
  'invictus': 'Invictus 3',
  
  // KNU SKOOL
  'knu skool': 'Knu Skool',
  'quinu skool': 'Knu Skool',
  'vans knu': 'Knu Skool',
  'knu skol': 'Knu Skool',
  'knu skul': 'Knu Skool',
  'skool knu': 'Knu Skool',
  'vans quinu': 'Knu Skool',
  
  // NEW BALANCE
  'new balance': 'New Balance',
  'novo balanço': 'New Balance',
  'nil balance': 'New Balance',

  // OLD SKOOL
  'old skool': 'Old Skool',
  'vans old': 'Old Skool',
  'vans tradicional': 'Old Skool',
  'vans classico': 'Old Skool',

  // OLD SKOOL BOTA
  'old skool bota': 'Old Skool Bota',
  'vans botinha': 'Old Skool Bota',
  'vans cano alto': 'Old Skool Bota',
  'vans bota': 'Old Skool Bota',

  // MIZUNO PROPHECY
  'prophecy 8': 'Prophecy 8',
  'profecy 8': 'Prophecy 8',
  'profeci 8': 'Prophecy 8',
  'propecy 8': 'Prophecy 8',
  'mizuno prophecy 8': 'Prophecy 8',
  'mizuno profici 8': 'Prophecy 8',
  ...
  // ULTRA RANGER
  'ultra ranger': 'Ultra Ranger',
  'ultra range': 'Ultra Ranger',
  'ranger': 'Ultra Ranger',
  'ultra rang': 'Ultra Ranger',

  // ULTRA BOOST
  'ultra boost': 'Ultra Boost',
  'ultra bost': 'Ultra Boost',
  ...
  'bag': 'Bag',
  'mochila pequena': 'Bag',
  'mochila pequena transversal': 'Bag',
  'mochila transversal': 'Bag',
  'meia cano alto': 'Meia Cano Alto',
  'meia cumprida': 'Meia Cano Alto',
  'meia comprida': 'Meia Cano Alto',
  'meia media': 'Meia Cano Alto',
  'meia alta': 'Meia Cano Alto',
};
...
function isDescendenteDe(categoriaId, categoriaPaiId, todasAsCategoriasMap) {
  ...
  while (categoriaAtual) {
    ...
    if (categoriaAtual.id === categoriaPaiId || categoriaAtual.parent === categoriaPaiId) {
      return true;
    }
